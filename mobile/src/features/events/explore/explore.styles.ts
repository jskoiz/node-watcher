...
export const exploreStyles = StyleSheet.create({
  ...
  heroEyebrow: { fontSize: 10, fontWeight: '900', letterSpacing: 2, color: ACCENT, marginBottom: spacing.sm },
  heroTitle: { fontSize: 32, fontWeight: '800', letterSpacing: -1.2, color: TEXT_PRIMARY, lineHeight: 36, marginBottom: spacing.sm },
  heroSubtitle: { fontSize: typography.body, fontWeight: '500', color: TEXT_MUTED, lineHeight: 22, maxWidth: 320 },
  ...
  eventCard: { borderRadius: 18, borderWidth: 0, marginBottom: spacing.md, overflow: 'hidden', backgroundColor: SURFACE, padding: 0, ...CARD_SHADOW },
  eventBanner: { height: 140, overflow: 'hidden' as const },
  eventBannerImage: { ...StyleSheet.absoluteFillObject, width: '100%', height: '100%' } as any,
  eventBannerOverlay: { ...StyleSheet.absoluteFillObject },
  eventBannerContent: { ...StyleSheet.absoluteFillObject, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end', padding: spacing.md },
