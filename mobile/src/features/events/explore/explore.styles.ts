...
export const exploreStyles = StyleSheet.create({
  ...
  eventCard: { borderRadius: 18, borderWidth: 1, borderColor: BORDER, marginBottom: spacing.md, overflow: 'hidden', backgroundColor: SURFACE },
  ...
  attendeesBadge: { backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: radii.pill, paddingHorizontal: spacing.sm, paddingVertical: 3, borderWidth: 1, borderColor: BORDER },
  ...
  spotsEmptyState: { marginTop: spacing.md, borderRadius: 16, borderWidth: 1, borderColor: BORDER, backgroundColor: 'rgba(255,255,255,0.03)', padding: spacing.md },
  ...
  spotCard: { width: SPOT_CARD_WIDTH, borderRadius: 18, borderWidth: 1, padding: spacing.md, backgroundColor: SURFACE },
  ...
  communityCard: { borderRadius: 16, borderWidth: 1, borderColor: BORDER, marginBottom: spacing.md, overflow: 'hidden', backgroundColor: SURFACE, flexDirection: 'row' },
  ...
  spotsBadge: { backgroundColor: 'rgba(52,211,153,0.12)', paddingHorizontal: spacing.sm, paddingVertical: 3, borderRadius: radii.pill, borderWidth: 1, borderColor: 'rgba(52,211,153,0.3)' },
  ...
  inviteSmallBtn: { paddingHorizontal: spacing.md, paddingVertical: 7, borderRadius: radii.pill, borderWidth: 1, borderColor: BORDER, backgroundColor: 'rgba(255,255,255,0.04)' },
