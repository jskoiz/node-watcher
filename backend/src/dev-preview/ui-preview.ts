...
export const UI_PREVIEW_USERS = [
  {
    ...
    fitness: {
      ...
      trainingStyle: 'Morning cardio blocks with one easy social session each week.',
      prefersMorning: true,
      prefersEvening: true,
    },
  },
  {
    ...
    fitness: {
      ...
      trainingStyle: 'Compact strength sessions, boxing rounds, and easy recovery miles.',
  ...
  },
  {
    ...
    fitness: {
      ...
      trainingStyle: 'Alternates outdoor effort days with mobility and technique work.',
      prefersMorning: true,
